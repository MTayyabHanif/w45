...
<?php if(have_posts()) :?>	
 ...
 <div class="car_3x3 container2 inside"> 
<!-- <div class="carosel_Hor_2x2 container2 inside"> -->
...
<?php// if($featured_slide) : ?>
 ...
 <div style="display:none" class="rsContent">
...
<div class="tc_thumb"   style="background-image: url(
        ...
        <p class="hide"><?php// echo $slide_button_label ?>This animated block is here just to show you that</p>
       </div>
