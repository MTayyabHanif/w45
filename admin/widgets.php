...
register_sidebar(array(
	...
	'id' => 'footer_1',
	'description' => __('Widget area for the footer on the home page.', 'themetrust'),
	'before_widget' => '<section id="%1$s" class="one_fourth %2$s">',
...
register_sidebar(array(
	...
	'id' => 'footer_2',
	'description' => __('Widget area for the footer on the home page.', 'themetrust'),
	'before_widget' => '<section id="%1$s" class="one_fourth mid %2$s  ">',
	'after_widget' => '</section>',
	'before_title' => '<h3>',
	'after_title' => '</h3>'
));
...
register_sidebar(array(
	...
	'id' => 'footer_4',
	'description' => __('Widget area for the footer on the home page.', 'themetrust'),
	'before_widget' => '<section id="%1$s" class="one_fourth last %2$s  ">',
	'after_widget' => '</section>',
	'before_title' => '<h3>',
	'after_title' => '</h3>'
));
...
register_sidebar(array(
	'name' => 'Events Feed',
	'id' => 'event_feed',
	'description' => __('Widget area for the events feed.', 'w45'),
	'before_widget' => '<div>',
	'after_widget' => '</div>',
	'before_title' => '<h3>',
	'after_title' => '</h3>'
