...
(function(l) {
	function v(b, f) {
		...
		a.st.arrowsNav && (c = a._n1, l('<div class="rsArrow rsArrowLeft"><div class="rsArrowIcn"></div></div><div class="rsArrow rsArrowRight"><div class="rsArrowIcn"></div></div>').appendTo(c), a._b2 = c.children(".rsArrowLeft").click(function(b) {
			b.preventDefault();
			a.prev()
						...
						if (b.isBig) l("<img />").on("load.rs error.rs", function() {
							...
							for (a = 0; a < b.images.length; a++) {
								...
								d.on("load.rs error.rs", function() {
									b.loaded.push(this);
									b.loaded.length === b.imgLoaders.length && g(b.loaded, !1)
								}).attr("src", b.images[a])
							}
						}
					}
	...
	j.extend(j.rsProto, {
		...
		_u4: function(k) {
			...
			k.each(function(k) {
				...
				if (f || d) c = {}, c.hasFade = Boolean(f), Boolean(d) && (c.moveProp = h, c.hasMove = !0), c.speed = b.data("speed"), isNaN(c.speed) && (c.speed = a.st.block.speed), c.easing = b.data("easing"), c.easing || (c.easing = a.st.block.easing), c.css3Easing = j.rsCSS3Easing[c.easing], c.delay = b.data("delay"), isNaN(c.delay) && (c.delay = a.st.block.delay * k);
				d = {};
...
(function(c) {
	c.extend(c.rsProto, {
		...
		_c6: function(a) {
			...
			a.content.hasClass("rsImg") ? a.content = c(b) : a.content.find(".rsMainSlideImage").replaceWith(b);
	...
	f.extend(f.rsProto, {
		...
		_y3: function(a, e, c, b, g) {
			...
			if (d._l6) {
				...
				var h = {};
				d._p6 = !0;
				d._d ? (h[d._f + "transition-duration"] = e + "ms", h[d._f + "transition-timing-function"] = c ? f.rsCSS3Easing[d.st.easeOut] : f.rsCSS3Easing[d.st.easeInOut], d._q3.css(h), d._o3(a)) : (h[d._c3 ? d._w1 : d._v1] = a + "px", d._q3.animate(h, e, c ? "easeOutCubic" : d.st.easeInOut));
				b && (d._g3 = b);
				d._y6();
		...
		_m6: function(a, e) {
			...
			this._l6 && (this._j6 && (e = !0, this._j6 = !1), f + this._g3 > this._x3 ? (a === this.numSlides - 1 && (c = 1), d = -a + this._u6 - 2 + c, b = d * this._t6 + this._x3 % this._t6 + this._v6 - this._l3) : 0 !== a ? (a - 1) * this._t6 <= -this._g3 + this._l3 && a - 1 <= this.numSlides - this._u6 && (b = (-a + 1) * this._t6 + this._l3) : b = this._l3, b !== this._g3 && (c = void 0 === b ? this._g3 : b, c > this._l3 ? this._o3(this._l3) : c < this._m3 ? this._o3(this._m3) : void 0 !== b && (e ? this._o3(b) : this._y3(b))), this._y6())
		}
	});
...
(function(e) {
	e.extend(e.rsProto, {
		_z6: function() {
			...
			a.st.video = e.extend({}, a._a7, a.st.video);
			a.ev.on("rsBeforeSizeSet", function() {
